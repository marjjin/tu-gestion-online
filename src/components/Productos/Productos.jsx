...
export function Productos() {
    ...
    for (const productId of selectedProducts) {
      ...
      if (bulkPriceIncrease && !isNaN(bulkPriceIncrease)) {
        ...
        if (producto.porcentaje_ganancia) {
          const nuevoPrecioFinal = nuevoPrecioCosto * (1 + producto.porcentaje_ganancia / 100);
  ...
  return (
    <div className="productos-container">
      ...
      {showBulkActions && (
        <div className="modal-overlay" onClick={bulkUpdateSuccess ? handleCloseBulkModal : undefined}>
              ...
              <>
                ...
                <div className="bulk-edit-form">
                  <label>
                    ...
                    <input
                      ...
                      step="0.01"
                    />
                    <small>Ingresa un número positivo para aumentar o negativo para disminuir el precio de costo</small>
                  </label>
                  ...
                  <label>
                    ...
                    <input
                      ...
                      step="0.01"
                    />
                    <small>Ingresa un número positivo para aumentar o negativo para disminuir el porcentaje de ganancia</small>
                  </label>
                ...
                <div className="modal-actions">
                  <button
                    ...
                    disabled={loading || (!bulkPriceIncrease && !bulkProfitIncrease && !bulkCategoryId)}
                  >
        ...
        <div className="modal-overlay" style={{ zIndex: 1001 }}>
          <div className="modal-content modal-confirm">
            ...
            <div className="confirm-details">
              <p><strong>Productos a modificar:</strong> {selectedProducts.length}</p>
              {bulkPriceIncrease && (
                <p><strong>Precio de costo:</strong> {parseFloat(bulkPriceIncrease) > 0 ? '+' : ''}{bulkPriceIncrease}%</p>
              )}
              {bulkProfitIncrease && (
                <p><strong>Ganancia:</strong> {parseFloat(bulkProfitIncrease) > 0 ? '+' : ''}{bulkProfitIncrease}%</p>
              )}
              {bulkCategoryId && (
                <p><strong>Nueva categoría:</strong> {categorias.find(c => c.id === bulkCategoryId)?.nombre}</p>
              )}
            </div>
            <p className="confirm-warning">Esta acción modificará los productos seleccionados.</p>
            <div className="modal-actions">
              <button
                className="modal-btn modal-btn-primary"
                onClick={() => {
